...
# --- 설정 변수 ---
hef_path = "/app/tappas/npu/yolov8n-seg.hef"  # 📌 여기에 Segmentation 모델 경로를 입력하세요.
...
print(f"Starting Segmentation inference with {len(image_files)} images...")
print("-" * 50)

for image_path in image_files:
    pipeline_str = (
        f"filesrc location={image_path} ! jpegdec ! videoconvert ! "
        "videoscale ! video/x-raw,format=RGB,width=320,height=320 ! "
